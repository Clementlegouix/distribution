...
class srcTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/DataCollector/EasyAdminDataCollector.php';
        ...
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Twig/EasyAdminTwigExtension.php';
        ...
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Cache/CacheManager.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/ConfigPassInterface.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/NormalizerConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/DesignConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/MenuConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/ActionConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/MetadataConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/PropertyConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/ViewConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/TemplateConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/DefaultConfigPass.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Configuration/ConfigManager.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/Router/EasyAdminRouter.php';
        include_once $this->targetDirs[3].'/vendor/javiereguiluz/easyadmin-bundle/src/EventListener/ControllerListener.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dWd1WMgbYw', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GwnyZ-2S1X', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector($a, ($this->targetDirs[0].'/srcTestDebugProjectContainer')));
    ...
    protected function getTwigService()
    {
        ...
        $g->setDisplayOptions(array('maxStringLength' => 4096, 'fileLinkFormat' => $c));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ijbB70xy-8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+s3VCKFEi4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JVOlr7SKag', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\UserType' => function () {
            ...
            yield 4 => ($this->privates['easyadmin.form.type.extension'] ?? $this->load(__DIR__.'/getEasyadmin_Form_Type_ExtensionService.php'));
