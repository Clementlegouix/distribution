...
// Returns the private 'App\Repository\AdherentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdherentRepository.php';

return $this->privates['App\Repository\AdherentRepository'] = new \App\Repository\AdherentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
