...
$a->setNamespace('sf_orm_default_5380694481db84207cd307146955070c3ab0cc8bf7200a84f864f6ea53eede86');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_5380694481db84207cd307146955070c3ab0cc8bf7200a84f864f6ea53eede86');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_5380694481db84207cd307146955070c3ab0cc8bf7200a84f864f6ea53eede86');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AdherentRepository' => function () {
    return ($this->privates['App\Repository\AdherentRepository'] ?? $this->load(__DIR__.'/getAdherentRepositoryService.php'));
}, 'App\\Repository\\PassageRepository' => function () {
    return ($this->privates['App\Repository\PassageRepository'] ?? $this->load(__DIR__.'/getPassageRepositoryService.php'));
}, 'App\\Repository\\RoleRepository' => function () {
    return ($this->privates['App\Repository\RoleRepository'] ?? $this->load(__DIR__.'/getRoleRepositoryService.php'));
