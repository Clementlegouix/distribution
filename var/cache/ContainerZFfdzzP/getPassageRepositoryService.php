...
// Returns the private 'App\Repository\PassageRepository' shared autowired service.
...
include_once $this->targetDirs[2].'/src/Repository/PassageRepository.php';

return $this->privates['App\Repository\PassageRepository'] = new \App\Repository\PassageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
