...
include_once $this->targetDirs[2].'/vendor/symfony/http-kernel/CacheWarmer/CacheWarmer.php';
include_once $this->targetDirs[2].'/vendor/symfony/framework-bundle/CacheWarmer/TemplatePathsCacheWarmer.php';
