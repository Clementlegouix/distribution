...
class __TwigTemplate_3a250977f875f94095d2c2fe7cc7eef0dc0844972555ba043fca69ac4420a49e extends Twig_Template
{
        ...
        if (twig_test_iterable(($context["value"] ?? null))) {
            ...
            if (("show" == ($context["view"] ?? null))) {
                ...
                ";
                    ...
                    $context['_seq'] = twig_ensure_traversable(twig_slice($this->env, ($context["value"] ?? null), 0, $this->env->getExtension('EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension')->getBackendConfiguration("show.max_results")));
                    foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                        ...
                        if (array_key_exists("link_parameters", $context)) {
                            ...
                            // line 10
                            echo "                            ";
                            $context["primary_key_value"] = ("" . twig_get_attribute($this->env, $this->getSourceContext(), $context["item"], twig_get_attribute($this->env, $this->getSourceContext(), ($context["link_parameters"] ?? null), "primary_key_name", array())));
                            // line 11
                            echo "                            <a href=\"";
                ...
                ";
                    // line 18
                    $context["_remaining_items"] = (twig_length_filter($this->env, ($context["value"] ?? null)) - $this->env->getExtension('EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension')->getBackendConfiguration("show.max_results"));
                    // line 19
                    echo "                ";
...
";
    ...
    {
        return new Twig_Source("", "EasyAdminBundle:default:field_association.html.twig", "/Users/clement/Projet/Distri/vendor/javiereguiluz/easyadmin-bundle/src/Resources/views/default/field_association.html.twig");
    }
}
